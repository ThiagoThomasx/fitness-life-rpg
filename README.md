...
- **Dashboard** — visão geral de XP, nível, atributos, missões diárias e seção Analytics (performance, consistência, balanceamento muscular, recuperação e insights observacionais por período)
