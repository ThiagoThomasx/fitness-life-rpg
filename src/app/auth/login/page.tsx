      ...
      <div className="login-card">
        ...
        {!isSupabaseConfigured && (
          <div className="mock-banner">
            <p>Modo local ativo — Supabase não configurado</p>
            <button onClick={handleMockLogin} className="btn-mock" disabled={loading}>
              {loading ? "Entrando..." : "Entrar como Herói Local"}
            </button>
          </div>
        )}
