...
export const CATEGORY_COLORS: Record<string, ThemeColor> = {
  ...
  default:     { bg: "rgba(29,185,84,0.08)",   border: "rgba(29,185,84,0.2)",     text: "#1db954", fill: "#1db954" },
}
...
export const REWARD_COLORS: Record<string, ThemeColor> = {
  ...
  attribute_up: { bg: "rgba(29,185,84,0.12)",  border: "rgba(29,185,84,0.3)",  text: "#1db954", fill: "#1db954" },
  xp:           { bg: "rgba(29,185,84,0.1)",   border: "rgba(29,185,84,0.25)", text: "#1db954", fill: "#1db954" },
}
...
export const MOOD_COLORS: Record<number, ThemeColor> = {
  ...
  3: { bg: "rgba(29,185,84,0.08)",  border: "rgba(29,185,84,0.2)",   text: "#1db954", fill: "#1db954" },
  4: { bg: "rgba(29,185,84,0.12)",  border: "rgba(29,185,84,0.3)",   text: "#1db954", fill: "#1db954" },
...
export function statusColor(
  ...
  if (pct >= thresholds.ok) return "#1db954"
...
export const PIE_PALETTE = [
  "#1db954", "#f59e0b", "#8b5cf6", "#3b82f6", "#ec4899", "#ef4444",
]
